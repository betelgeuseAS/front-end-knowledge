...
![browser-architecture](../assets/browser/007/browser-architecture.png)
...
- **Networking:** these are network calls such as XHR requests, made by using different implementations for the different platforms, which are behind a platform-independent interface.
...
- **JavaScript engine:** basically, this is where the JavaScript gets executed.
...
![rendering-process](../assets/browser/007/rendering-process.png)
...
![constructing-dom](../assets/browser/007/constructing-dom.png)
...
![constructing-dom](../assets/browser/007/constructing-cssom.png)
...
![constructing-render-tree](../assets/browser/007/constructing-render-tree.png)
...
- Move long-running JavaScript computations to Web Workers.
